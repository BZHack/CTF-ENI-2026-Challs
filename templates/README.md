...
_bonus_: si possible mettre un `solve.py` pour permettre a un helper de tester si le challenge fonctionne toujours. (python a privilégier mais autre possible)

| fichiers      | roles                                    |
| :------------ | :--------------------------------------- |
| challenge.yml | fichier de déploiement pour le ctfd      |
| WriteUp.md    | fichier de solution du challenge         |
| chall/        | répertoire pour les sources du challenge |
...
1. Il doit toujours avoir le nom `chall/` et se localiser à la racine du répertoire du challenge.
